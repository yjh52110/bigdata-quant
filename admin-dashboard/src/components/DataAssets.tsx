...
export default function DataAssets() {
  ...
  useEffect(() => {
    const load = () => {
      apiFetch('/api/data-assets').then(r => r.json()).then(setAssetsInfo).catch(console.error);
      apiFetch('/api/sync/status').then(r => r.json()).then(setSyncStatus).catch(console.error);
    };
    load();
